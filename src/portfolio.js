...
const openSource = {
  ...
  githubUserName: "naveenjujaray", // Change to your github username to view your profile in Contact Section.
  ...
  achivementsCards: [
    {
      ...
      subtitle: "AIR 75 and 143",
      image: require("./assets/images/icpc-logo.png"),
      footerLink: [
        { name: "Available on Code Drills", url: "https://codedrills.io/contests/icpc-amritapuri-2023-regional-round/scoreboard" },
      ]
    },
  ]
};
...
const contactInfo = {
  ...
  number: "XXX-XXX-XXXX",
  email_address: "devpro@gmail.com"
};
